                ...
                <tbody>
                  {
                    alarmEventlist.length > 0 ? alarmEventlist.map((ele, index) => {
                      return (
                        <tr key={index} onClick={() => toFly(ele)}>
                          ...
                          <td className="button">
                            <div className="queren" onClick={(e) => handleAlarm(e,"1", ele)}>确认</div>
                            <div className="hulue" onClick={(e) => handleAlarm(e,"2", ele)}>忽略</div>
                          </td>
                        </tr>
                      )
