...
const EleCtrlLeft = () => {
    ...
    const [allElevatorDatas] = useState([
                        ...
                        return (
                            <div key={index} className="health_item">
                                ...
                                <div className="healthChart" id={"health_pieChart"+index}>
                                    {
                                        item === "客梯"? <Progress 
                                            strokeColor={{'0%': '#8AFFF9','100%': '#00FFF1'}} 
                                            strokeWidth="10"
                                            status="active"
                                            type="circle" 
                                            percent={pieNums.keti} 
                                            width={98}
                                            strokeLinecap="square" 
                                            trailColor="none"
                                        />: <Progress 
                                            strokeColor={{'0%': '#FFF124','100%': '#FFFAB1'}} 
                                            strokeWidth="10"
                                            type="circle" 
                                            percent={pieNums.huoti} 
                                            width={98}
                                            strokeLinecap="square" 
                                            trailColor="none"
                                        />
