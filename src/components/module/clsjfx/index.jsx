  ...
  return (
    <div id="DoorApply" className="DoorApply">
      ...
      <div className='cheliang'>
        <div className='icon-cheliang'>
          <img src={cheliang} alt="" />
          <div className='slice-1'>
            <p>工作车辆</p>
            <p className='Math-1'>189</p>
          </div>
          <div className='slice-2'>
            <p>访客车辆</p>
            <p className='Math-2'>146</p>
          </div>
          <div className='slice-3'>
            <p>陌生车辆</p>
            <p className='Math-3'>98</p>
          </div>
        </div>
      </div>
      <div className="management">
          <div className="cheliang_top_1">
            <h1>车辆管理</h1>
            <img src={title_1} alt=""/>
          </div>
      </div>
...
export default DoorApply_copy_1;