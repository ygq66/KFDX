...
const DoorApply_copy_5 = (props) => {
  ...
  return (
    <div id="DoorApply" className="DoorApply">
      ...
      <div className='gongdan'>
        <div className='gongdan-1'>
          <img src={group} alt="" />
          <p>工单总数</p>
          <span>3356</span>
          <h1>/单</h1>
        </div>
        <div className='gongdan-2'>
          <img src={group} alt="" />
          <p>今日工单数</p>
          <span>123</span>
          <h1>/单</h1>
      ...
      <div className='content'>
        <div className='content-1'>
          ...
          <div className='content_middle'>
            <div className='content_middle_1'>
              <p>时间：</p>
              <span>2021-08-01 11:42:26</span>
            </div>
            <div className='content_middle_2'>
              <p>发起人：</p>
              <span>张丽娜</span>
            </div>
            <div className='content_middle_3'>
              <p>分类：</p>
              <span>访客预约</span>
            </div>
            <div className='content_middle_4'>
              <p>状态：</p>
              <span>未处理</span>
            </div>
          </div>
        ...
        <div className='content-2'>
          ...
          <div className='content_middle'>
            <div className='content_middle_5'>
              <p>时间：</p>
              <span>2021-08-01 11:42:26</span>
            </div>
            <div className='content_middle_6'>
              <p>发起人：</p>
              <span>张丽娜</span>
            </div>
            <div className='content_middle_7'>
              <p>分类：</p>
              <span>快递收发</span>
            </div>
            <div className='content_middle_8'>
              <p>状态：</p>
              <span>未处理</span>
            </div>
          </div>
        ...
        <div className='content-3'>
          ...
          <div className='content_middle'>
            <div className='content_middle_9'>
              <p>时间：</p>
              <span>2021-08-01 11:42:26</span>
            </div>
            <div className='content_middle_10'>
              <p>发起人：</p>
              <span>张丽娜</span>
            </div>
            <div className='content_middle_11'>
              <p>分类：</p>
              <span>快递收发</span>
            </div>
            <div className='content_middle_12'>
              <p>状态：</p>
              <span>未处理</span>
            </div>
          </div>
...
export default DoorApply_copy_5;